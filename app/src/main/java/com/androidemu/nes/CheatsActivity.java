...
public class CheatsActivity extends ListActivity {
	...
	private final Cheats cheats = Emulator.getInstance().getCheats();
	...
	protected Dialog onCreateDialog(int id) {
		if (id == DIALOG_EDIT_CHEAT) {
			...
			return new AlertDialog.Builder(this).
					...
					setView(View.inflate(this, R.layout.new_cheat, null)).
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case MENU_ITEM_EDIT:
			currentCheat = adapter.getItem(info.position);
			showDialog(DIALOG_EDIT_CHEAT);
			return true;
